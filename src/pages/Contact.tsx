                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex items-start space-x-3 pt-2">
                      ...
                      <label htmlFor="consent" className="text-sm text-muted-foreground leading-relaxed">
                        By checking this box, I consent to receive automated voice calls from Lavanya for service and promotional purposes. I understand these may be generated by AI. I have read and agree to the{" "}
                        <Link 
                          to="/terms" 
