        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h1 className="text-2xl font-bold">Book {service.ProductName}</h1>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold">{service.ProductName || service.Services}</h1>
              <p className="text-muted-foreground">{service.Category} • {service.SubCategory}</p>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Service: {service.Services}</span>
                  </div>
                  {service.Subservice && (
                    <div className="flex items-center gap-2">
                      <Star className="h-4 w-4 text-gray-500" />
                      <span>Specialty: {service.Subservice}</span>
                    </div>
                  )}
                  {service.Scheme && (
                    <div className="flex items-center gap-2">
                      <Shield className="h-4 w-4 text-gray-500" />
                      <span>Package: {service.Scheme}</span>
                    </div>
                  )}
                  <div className="flex items-center gap-2">
